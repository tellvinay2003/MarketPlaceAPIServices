...
namespace MarketPlaceService.DAL.Models
{
    public partial class MarketplaceDbContext : DbContext
    {
        ...
        public virtual DbSet<BookingUpdateFromPublisherQueue> BookingUpdateFromPublisherQueue { get; set; }
        public virtual DbSet<BookingUpdateFromPublisherQueueHistory> BookingUpdateFromPublisherQueueHistory { get; set; }
        public virtual DbSet<BookingUpdateStatus> BookingUpdateStatus { get; set; }
        ...
        public virtual DbSet<MarketplaceBooking> MarketplaceBooking { get; set; }
        public virtual DbSet<MarketplaceBookingHistory> MarketplaceBookingHistory { get; set; }
        public virtual DbSet<MarketplaceBookingPushQueue> MarketplaceBookingPushQueue { get; set; }
        public virtual DbSet<MarketplaceBookingPushQueueHistory> MarketplaceBookingPushQueueHistory { get; set; }
        ...
        public virtual DbSet<SiteBooking> SiteBooking { get; set; }
        public virtual DbSet<SiteBookingHistory> SiteBookingHistory { get; set; }
        public virtual DbSet<SiteBookingPublisher> SiteBookingPublisher { get; set; }
        public virtual DbSet<SiteBookingPushQueue> SiteBookingPushQueue { get; set; }
        public virtual DbSet<SiteBookingPushQueueHistory> SiteBookingPushQueueHistory { get; set; }
        ...
        public virtual DbSet<UserAccountRefreshToken> UserAccountRefreshToken { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        {
            modelBuilder.Entity<BookingUpdateFromPublisherQueue>(entity =>
            {
                entity.ToTable("BOOKING_UPDATE_FROM_PUBLISHER_QUEUE");

                entity.Property(e => e.Bookingupdatefrompublisherqueueid)
                    .HasColumnName("BOOKINGUPDATEFROMPUBLISHERQUEUEID")
                ...
                entity.Property(e => e.Publisherbookingid).HasColumnName("PUBLISHERBOOKINGID");

                entity.Property(e => e.Publishersiteid).HasColumnName("PUBLISHERSITEID");

                entity.Property(e => e.Retrycount).HasColumnName("RETRYCOUNT");

                entity.Property(e => e.Sitebookingid).HasColumnName("SITEBOOKINGID");

                entity.Property(e => e.Traceid).HasColumnName("TRACEID");

                entity.HasOne(d => d.Jobstatus)
                    .WithMany(p => p.BookingUpdateFromPublisherQueue)
                    .HasForeignKey(d => d.Jobstatusid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BOOKING_U__JOBST__4119A21D");

                entity.HasOne(d => d.Publishersite)
                    .WithMany(p => p.BookingUpdateFromPublisherQueue)
                    .HasForeignKey(d => d.Publishersiteid)
                    .HasConstraintName("FK__BOOKING_U__PUBLI__40257DE4");
            });

            modelBuilder.Entity<BookingUpdateFromPublisherQueueHistory>(entity =>
            {
                entity.ToTable("BOOKING_UPDATE_FROM_PUBLISHER_QUEUE_HISTORY");

                entity.Property(e => e.Bookingupdatefrompublisherqueuehistoryid)
                    .HasColumnName("BOOKINGUPDATEFROMPUBLISHERQUEUEHISTORYID")
                    .HasDefaultValueSql("(newid())");

                entity.Property(e => e.Bookingdata)
                    .HasColumnName("BOOKINGDATA")
                    .IsUnicode(false);

                entity.Property(e => e.Bookingupdatefrompublisherqueueid).HasColumnName("BOOKINGUPDATEFROMPUBLISHERQUEUEID");
                ...
                entity.HasOne(d => d.Jobstatus)
                    .WithMany(p => p.BookingUpdateFromPublisherQueueHistory)
                    .HasForeignKey(d => d.Jobstatusid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BOOKING_U__JOBST__45DE573A");

                entity.HasOne(d => d.Publishersite)
                    .WithMany(p => p.BookingUpdateFromPublisherQueueHistory)
                    .HasForeignKey(d => d.Publishersiteid)
                    .HasConstraintName("FK__BOOKING_U__PUBLI__44EA3301");
            });

            modelBuilder.Entity<BookingUpdateStatus>(entity =>
            {
                entity.ToTable("BOOKING_UPDATE_STATUS");

                entity.Property(e => e.Bookingupdatestatusid)
                    .HasColumnName("BOOKINGUPDATESTATUSID")
                    .ValueGeneratedNever();

                entity.Property(e => e.Bookingupdatestatusname)
                    .IsRequired()
                    .HasColumnName("BOOKINGUPDATESTATUSNAME")
                    .HasMaxLength(50);
            });
            ...
            modelBuilder.Entity<MarketplaceBooking>(entity =>
            {
                entity.ToTable("MARKETPLACE_BOOKING");

                entity.Property(e => e.Marketplacebookingid)
                    .HasColumnName("MARKETPLACEBOOKINGID")
                    .HasDefaultValueSql("(newid())");
                ...
                entity.Property(e => e.Bookingversion).HasColumnName("BOOKINGVERSION");
                ...
                entity.Property(e => e.SubscriberBookingId).HasColumnName("SUBSCRIBER_BOOKING_ID");

                entity.Property(e => e.SubscriberBookingRef)
                    .HasColumnName("SUBSCRIBER_BOOKING_REF")
                    .HasMaxLength(150)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.Subscriber)
                    .WithMany(p => p.MarketplaceBooking)
                    .HasForeignKey(d => d.Subscriberid)
                    .HasConstraintName("FK__MARKETPLA__SUBSC__2D12A970");

                entity.HasOne(d => d.Subscribersite)
                    .WithMany(p => p.MarketplaceBooking)
                    .HasForeignKey(d => d.Subscribersiteid)
                    .HasConstraintName("FK__MARKETPLA__SUBSC__2E06CDA9");
            });

            modelBuilder.Entity<MarketplaceBookingHistory>(entity =>
            {
                entity.ToTable("MARKETPLACE_BOOKING_HISTORY");

                entity.Property(e => e.Marketplacebookinghistoryid)
                    .HasColumnName("MARKETPLACEBOOKINGHISTORYID")
                    .HasDefaultValueSql("(newid())");
                ...
                entity.Property(e => e.Bookingdatadiff).HasColumnName("BOOKINGDATADIFF");
                ...
                entity.Property(e => e.Marketplacebookingid).HasColumnName("MARKETPLACEBOOKINGID");
                ...
                entity.HasOne(d => d.Marketplacebooking)
                    .WithMany(p => p.MarketplaceBookingHistory)
                    .HasForeignKey(d => d.Marketplacebookingid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__MARKETPLA__MARKE__49AEE81E");

                entity.HasOne(d => d.Subscriber)
                    .WithMany(p => p.MarketplaceBookingHistory)
                    .HasForeignKey(d => d.Subscriberid)
                    .HasConstraintName("FK__MARKETPLA__SUBSC__4AA30C57");

                entity.HasOne(d => d.Subscribersite)
                    .WithMany(p => p.MarketplaceBookingHistory)
                    .HasForeignKey(d => d.Subscribersiteid)
                    .HasConstraintName("FK__MARKETPLA__SUBSC__4B973090");
            });

            modelBuilder.Entity<MarketplaceBookingPushQueue>(entity =>
            {
                entity.ToTable("MARKETPLACE_BOOKING_PUSH_QUEUE");

                entity.Property(e => e.Marketplacebookingpushqueueid)
                    .HasColumnName("MARKETPLACEBOOKINGPUSHQUEUEID")
                    .HasDefaultValueSql("(newid())");

                entity.Property(e => e.Bookingid).HasColumnName("BOOKINGID");

                entity.Property(e => e.Jobcreateddatetime)
                    .HasColumnName("JOBCREATEDDATETIME")
                    .HasColumnType("datetime");
                ...
                entity.HasOne(d => d.Subscribersite)
                    .WithMany(p => p.MarketplaceBookingPushQueue)
                    .HasForeignKey(d => d.Subscribersiteid)
                    .HasConstraintName("FK__MARKETPLA__SUBSC__06ED0088");
            });

            modelBuilder.Entity<MarketplaceBookingPushQueueHistory>(entity =>
            {
                entity.ToTable("MARKETPLACE_BOOKING_PUSH_QUEUE_HISTORY");

                entity.Property(e => e.Marketplacebookingpushqueuehistoryid)
                    .HasColumnName("MARKETPLACEBOOKINGPUSHQUEUEHISTORYID")
                    .HasDefaultValueSql("(newid())");
                ...
                entity.Property(e => e.Marketplacebookingpushqueueid).HasColumnName("MARKETPLACEBOOKINGPUSHQUEUEID");
                ...
                entity.HasOne(d => d.Subscribersite)
                    .WithMany(p => p.MarketplaceBookingPushQueueHistory)
                    .HasForeignKey(d => d.Subscribersiteid)
                    .HasConstraintName("FK__MARKETPLA__SUBSC__0ABD916C");
            });
            ...
            modelBuilder.Entity<MasterData>(entity =>
            {
                ...
                entity.Property(e => e.Servicetypepublishermainaddress)
                    .IsRequired()
                    .HasColumnName("SERVICETYPEPUBLISHERMAINADDRESS")
            ...
            modelBuilder.Entity<PublisherAgent>(entity =>
            {
                ...
                entity.Property(e => e.BookingPrefixId).HasColumnName("BookingPrefixID");
            ...
            modelBuilder.Entity<PublisherDefault>(entity =>
            {
                ...
                entity.Property(e => e.PackagePriceStartDate)
                    .HasColumnType("datetime")
                    .HasColumnName("PACKAGEPRICESTARTDATE");
            ...
            modelBuilder.Entity<PublisherServiceStatus>(entity =>
            {
                ...
                entity.Property(e => e.PackageStatusId).HasColumnName("PACKAGESTATUSID");
            ...
            modelBuilder.Entity<SiteBooking>(entity =>
            {
                entity.ToTable("SITE_BOOKING");

                entity.Property(e => e.Sitebookingid)
                    .HasColumnName("SITEBOOKINGID")
                    .HasDefaultValueSql("(newid())");
                ...
                entity.Property(e => e.PublisherBookingRef)
                    .HasColumnName("PUBLISHER_BOOKING_REF")
                    .HasMaxLength(150)
                    .IsUnicode(false);

                entity.Property(e => e.Publisherbookingid).HasColumnName("PUBLISHERBOOKINGID");

                entity.Property(e => e.Publisherbookinginfo)
                    .HasColumnName("PUBLISHERBOOKINGINFO")
                    .IsUnicode(false);

                entity.Property(e => e.Publisherbookinginfodiff)
                    .HasColumnName("PUBLISHERBOOKINGINFODIFF")
                    .IsUnicode(false);
                ...
                entity.Property(e => e.Subscriberbookinginfodiff)
                    .HasColumnName("SUBSCRIBERBOOKINGINFODIFF")
                    .IsUnicode(false);

                entity.HasOne(d => d.Publisher)
                    .WithMany(p => p.SiteBooking)
                    .HasForeignKey(d => d.Publisherid)
                    .HasConstraintName("FK_SITE_BOOKING_PUBLISHER_PUBLISHERID");

                entity.HasOne(d => d.Publishersite)
                    .WithMany(p => p.SiteBooking)
                    .HasForeignKey(d => d.Publishersiteid)
                    .HasConstraintName("FK__SITE_BOOK__PUBLI__32CB82C6");
            });

            modelBuilder.Entity<SiteBookingHistory>(entity =>
            {
                entity.ToTable("SITE_BOOKING_HISTORY");

                entity.Property(e => e.Sitebookinghistoryid)
                    .HasColumnName("SITEBOOKINGHISTORYID")
                    .HasDefaultValueSql("(newid())");
                ...
                entity.HasOne(d => d.Marketplacebooking)
                    .WithMany(p => p.SiteBookingHistory)
                    .HasForeignKey(d => d.Marketplacebookingid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__SITE_BOOK__MARKE__52442E1F");

                entity.HasOne(d => d.Publisher)
                    .WithMany(p => p.SiteBookingHistory)
                    .HasForeignKey(d => d.Publisherid)
                    .HasConstraintName("FK_SITE_BOOKING_HISTORY_PUBLISHER_PUBLISHERID");

                entity.HasOne(d => d.Publishersite)
                    .WithMany(p => p.SiteBookingHistory)
                    .HasForeignKey(d => d.Publishersiteid)
                    .HasConstraintName("FK__SITE_BOOK__PUBLI__515009E6");

                entity.HasOne(d => d.Sitebooking)
                    .WithMany(p => p.SiteBookingHistory)
                    .HasForeignKey(d => d.Sitebookingid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__SITE_BOOK__SITEB__4F67C174");
            });

            modelBuilder.Entity<SiteBookingPublisher>(entity =>
            {
                entity.ToTable("SITE_BOOKING_PUBLISHER");

                entity.Property(e => e.Sitebookingpublisherid)
                    .HasColumnName("SITEBOOKINGPUBLISHERID")
                    .HasDefaultValueSql("(newid())");

                entity.Property(e => e.Isprimarypublisher).HasColumnName("ISPRIMARYPUBLISHER");
                ...
                entity.HasOne(d => d.Publisher)
                    .WithMany(p => p.SiteBookingPublisher)
                    .HasForeignKey(d => d.Publisherid)
                    .HasConstraintName("FK__SITE_BOOK__PUBLI__469D7149");

                entity.HasOne(d => d.Sitebooking)
                    .WithMany(p => p.SiteBookingPublisher)
                    .HasForeignKey(d => d.Sitebookingid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__SITE_BOOK__SITEB__45A94D10");
            });

            modelBuilder.Entity<SiteBookingPushQueue>(entity =>
            {
                entity.ToTable("SITE_BOOKING_PUSH_QUEUE");

                entity.Property(e => e.Sitebookingpushqueueid)
                    .HasColumnName("SITEBOOKINGPUSHQUEUEID")
                    .HasDefaultValueSql("(newid())");
                ...
                entity.HasOne(d => d.Publishersite)
                    .WithMany(p => p.SiteBookingPushQueuePublishersite)
                    .HasForeignKey(d => d.Publishersiteid)
                    .HasConstraintName("FK__SITE_BOOK__PUBLI__18178C8A");

                entity.HasOne(d => d.Sitebooking)
                    .WithMany(p => p.SiteBookingPushQueue)
                    .HasForeignKey(d => d.Sitebookingid)
                    .HasConstraintName("FK__SITE_BOOK__SITEB__2CDD9F46");

                entity.HasOne(d => d.Subscribersite)
                    .WithMany(p => p.SiteBookingPushQueueSubscribersite)
                    .HasForeignKey(d => d.Subscribersiteid)
                    .HasConstraintName("FK__SITE_BOOK__SUBSC__190BB0C3");
            });

            modelBuilder.Entity<SiteBookingPushQueueHistory>(entity =>
            {
                entity.ToTable("SITE_BOOKING_PUSH_QUEUE_HISTORY");

                entity.Property(e => e.Sitebookingpushqueuehistoryid)
                    .HasColumnName("SITEBOOKINGPUSHQUEUEHISTORYID")
                    .HasDefaultValueSql("(newid())");
                ...
                entity.HasOne(d => d.Publishersite)
                    .WithMany(p => p.SiteBookingPushQueueHistoryPublishersite)
                    .HasForeignKey(d => d.Publishersiteid)
                    .HasConstraintName("FK__SITE_BOOK__PUBLI__1CDC41A7");

                entity.HasOne(d => d.Sitebooking)
                    .WithMany(p => p.SiteBookingPushQueueHistory)
                    .HasForeignKey(d => d.Sitebookingid)
                    .HasConstraintName("FK__SITE_BOOK__SITEB__2FBA0BF1");

                entity.HasOne(d => d.Subscribersite)
                    .WithMany(p => p.SiteBookingPushQueueHistorySubscribersite)
                    .HasForeignKey(d => d.Subscribersiteid)
                    .HasConstraintName("FK__SITE_BOOK__SUBSC__1DD065E0");
            });
            ...
            modelBuilder.Entity<SubscriberDefaultSellingPrices>(entity =>
            {
                ...
                entity.Property(e => e.Allservicetypes).HasColumnName("ALLSERVICETYPES");
            ...
            modelBuilder.Entity<SubscriberProduct>(entity =>
            {
                ...
                entity.Property(e => e.Subscribedby).HasColumnName("SUBSCRIBEDBY");
            ...
            modelBuilder.Entity<UserAccountRefreshToken>(entity =>
            {
                entity.HasOne(d => d.UserAccount)
                    .WithMany(p => p.UserAccountRefreshToken)
